...
def buscar_documento(documento_id):
    ...
    if documento is None:
        return None
    return {'id': documento_id, **documento}


def usuario_tem_acesso(usuario, documento_id, documento):
    ...
    documentos_permitidos = VINCULOS.get(usuario.get('id'), [])
    return documento_id in documentos_permitidos
...
def visualizar_documento(documento_id):
    ...
    if not usuario_tem_acesso(usuario, documento_id, documento):
